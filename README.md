...
完整 9 個命令（含 `/maigo:fix`、`/maigo:remember`、`/maigo:memory`、`/maigo:retro`、`/maigo:describe-pr`、`/maigo:address-comments`）詳見 [Commands reference](https://github.com/Lee-W/maigo/blob/main/docs/reference/commands.md)。
