...
完整 13 個命令（含 `/maigo:quick`、`/maigo:remember`、`/maigo:memory`、`/maigo:retro`、`/maigo:crystallize`、`/maigo:describe-pr`、`/maigo:address-comments`、`/maigo:triage-issue`、`/maigo:doctor`、`/maigo:repo-audit`）詳見 [Commands reference](https://github.com/Lee-W/maigo/blob/main/docs/reference/commands.md)。
