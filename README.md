...
完整 8 個命令（含 `/maigo:fix`、`/maigo:remember`、`/maigo:memory`、`/maigo:retro`、`/maigo:describe-pr`）詳見 [Commands reference](https://github.com/Lee-W/maigo/blob/main/docs/reference/commands.md)。
