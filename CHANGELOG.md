...
- **worktree**: switch maigo's worktree layout from sibling to nested
...
- configure role models across agent hosts

## v0.58.1 (2026-09-09)

### Fix

- verify quick tasks across agent hosts
...
- **hooks**: block acceptance criteria that prove a property by grep count
...
- **board**: streamline the Work Board reading view

## v0.51.2 (2026-08-09)

### Fix

- **hooks**: verify committed work instead of skipping it

## v0.51.1 (2026-08-07)

### Fix

- **codex**: disable incompatible Claude lifecycle hooks
...
- **skills**: mount orchestrator-voice alongside narration in commands
...
- **validate**: keep contributor checks in sync
...
- **hooks**: track subagent token usage
