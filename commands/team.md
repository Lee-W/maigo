...
6. **合流**——兩邊都回來後一起處理
7. **Orchestrator** — 合流 APPROVED + PASS 後，若還有未 commit 的本次變更，依 [`skills/commit-message`](https://github.com/Lee-W/maigo/blob/main/skills/commit-message/SKILL.md) 草擬一段 commit message 附在 final summary。**不自動跑 git commit**。
